# Generated by Django 5.0 on 2024-04-17 11:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer_surname', models.CharField(max_length=100, verbose_name='Фамилия покупателя')),
                ('customer_name', models.CharField(max_length=100, verbose_name='Имя покупателя')),
                ('customer_patronymic', models.CharField(blank=True, max_length=100, null=True, verbose_name='Отчество покупателя')),
                ('delivery_address', models.CharField(max_length=100, verbose_name='Адрес')),
                ('delivery_type', models.CharField(choices=[('SH', 'Магазин'), ('CR', 'Курьер'), ('PP', 'Пункт выдачи')], default='SH', max_length=2, verbose_name='Тип доставки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameters', models.ManyToManyField(through='shop.Pos_parameter', to='shop.parameter')),
        ...
        migrations.AddField(
            model_name='order',
            name='products',
            field=models.ManyToManyField(through='shop.Pos_order', to='shop.product', verbose_name='Товары'),
        ),
        migrations.CreateModel(
            name='Supply',
            fields=[
                ...
                ('products', models.ManyToManyField(through='shop.Pos_supply', to='shop.product', verbose_name='Товары')),
            ],
            options={
